...
const IndexPage = ({ data, pathContext }) => {
  ...
  return (
      ...
      <div className="home-template">
        ...
        <Header image='https://khamphadisan.com.vn/wp-content/uploads/2018/08/dao-nhat-tu-son-khamphadisan-3-1280x720.jpg' title="PHÚ QUỐC Điểm Hẹn" tagline="Chuyến đi Của Tôi.." />
